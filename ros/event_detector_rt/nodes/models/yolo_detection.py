...
def yoloDetect(model_output, input_shape, threshold=None):
    ...
    # print("cell_map_shape = ", cell_map_shape)
    # print("cell_shape = ", cell_shape)
    # print("x_norm_rel shape = ", x_norm_rel.shape)
    # print("y_norm_rel shape = ", y_norm_rel.shape)
    # print("cell_top_left shape = ", cell_top_left.shape)
    # print("torch stack shape = ", torch.stack([x_rel, y_rel], dim=-1).shape)

    bbox_center = cell_top_left[None, :, :, None, :] + torch.stack([x_rel, y_rel], dim=-1) #problem
